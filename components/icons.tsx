...
export const PartyPopperIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M4 14.5c3-5.5 8-8 8-8s3 2.5 8 8" />
    <path d="M14 4.5c2 2.5 2 4.5 0 6" />
    <path d="M19.5 15c2-2.5 2-4.5 0-6" />
    <path d="m22 2-1.5 1.5" />
    <path d="m15 6 1.5-1.5" />
    <path d="m19 10 1.5-1.5" />
    <path d="m10 17 1.5-1.5" />
  </svg>
);
...
/**
 * ESTE É O COMPONENTE DA LOGO
 * Para alterar a logo, edite os paths internos deste SVG.
 */
export const EventSnapLogoIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg
    {...props}
    viewBox="0 0 32 32"
    fill="none"
  ...
  >
    <path
      d="M29.3333 7.66667H22.5L20.3333 5H11.6667L9.5 7.66667H5.66667C4.56206 7.66667 3.66667 8.56206 3.66667 9.66667V24.3333C3.66667 25.4379 4.56206 26.3333 5.66667 26.3333H29.3333C30.4379 26.3333 31.3333 25.4379 31.3333 24.3333V9.66667C31.3333 8.56206 30.4379 7.66667 29.3333 7.66667Z"
      stroke="currentColor"
      strokeWidth="3"
      strokeLinecap="round"
    ...
    <path
      ...
      strokeLinejoin="round"
    />
    <path d="M14 13H15V14H14V13Z" fill="currentColor" />
    <path d="M17 13H18V14H17V13Z" fill="currentColor" />
    <path d="M12.5 15.5H14V17H12.5V15.5Z" fill="currentColor" />
    <path d="M15.5 15.5H17V17H15.5V15.5Z" fill="currentColor" />
    <path d="M12.5 18.5H14V20H12.5V18.5Z" fill="currentColor" />
    <path d="M17 18.5H18.5V20H17V18.5Z" fill="currentColor" />
    <path d="M18.5 15.5H20V17H18.5V15.5Z" fill="currentColor" />
    <path d="M11 14V12.5H12.5V14H11Z" fill="currentColor" />
  </svg>
);
